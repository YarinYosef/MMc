      ...
      {ratingOverlayOpen && (
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.15 }}
            className="bg-slate-800 border border-slate-700 rounded-lg shadow-xl p-6 w-96"
            onClick={(e) => e.stopPropagation()}
          >
            {submitted ? (
              <div className="text-center py-4">
                <div className="text-2xl mb-2">&#10003;</div>
                <div className="text-sm text-slate-200">Thanks for your rating!</div>
              ...
              <div className="text-center py-4">
                <div className="text-sm text-slate-200 mb-2">Daily limit reached</div>
                ...
                <button
                  onClick={handleClose}
                  className="mt-4 px-4 py-1.5 text-xs text-slate-300 rounded border border-slate-600 hover:bg-slate-700 transition-colors"
                >
                  Close
                </button>
              </div>
              ...
              <>
                <div className="text-center mb-3">
                  <div className="text-sm font-semibold text-slate-200">Rate Importance</div>
                ...
                {/* Scale labels */}
                <div className="flex justify-between text-[9px] text-slate-600 px-1 mb-3">
                  <span>Low</span>
                  <span>Medium</span>
                  <span>High</span>
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    onClick={handleClose}
                    className="flex-1 py-1.5 text-xs text-slate-400 hover:text-slate-200 rounded border border-slate-600 hover:bg-slate-700 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
