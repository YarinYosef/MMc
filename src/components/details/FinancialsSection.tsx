...
export function FinancialsSection({ symbol, expanded }: { symbol: string; expanded?: boolean }) {
  ...
  return (
    <div className="space-y-3 overflow-y-auto" style={{ scrollbarWidth: 'thin' }}>
      {/* Timeframe controls */}
      ...
      <div>
        <div className="text-[10px] text-[#999999] mb-1 font-medium">Revenue vs Net Income</div>
        <div
          className={cn(
          ...
          onClick={expanded ? undefined : () => setExpandedChart({ section: 'financials', chartId: 'revenue' })}
        >
      ...
      {/* Cash vs Debt */}
      <div>
        <div className="text-[10px] text-[#999999] mb-1 font-medium">Cash vs Debt</div>
        <div
          className={cn(
            expanded ? 'h-[60vh]' : 'h-36',
            'overflow-hidden',
          ...
          onClick={expanded ? undefined : () => setExpandedChart({ section: 'financials', chartId: 'cashDebt' })}
        >
          <ResponsiveContainer width="100%" height="100%">
      ...
      {sankeyData && (
        <div>
          <div className="text-[10px] text-[#999999] mb-1 font-medium">Income Flow (Sankey)</div>
          <div
            className={!expanded ? 'cursor-pointer hover:opacity-90 transition-opacity' : ''}
            onClick={expanded ? undefined : () => setExpandedChart({ section: 'financials', chartId: 'sankey' })}
          >
