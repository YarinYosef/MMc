    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <svg width="8" height="8" viewBox="0 0 8 8" fill="currentColor" className="text-[#999999]">
        ...
        <button
          ...
          className="text-[#777777] hover:text-[#999999] transition-colors p-0.5"
        >
          <svg
            width="12"
            height="12"
      ...
      <AnimatePresence initial={false}>
        {!minimized && (
          ...
          >
            <div className="px-2 pb-2 min-w-0 overflow-x-hidden">
              {renderContent()}
            </div>
          </motion.div>
        )}
...
function ExpandedChartContent({ section, symbol }: { section: DetailsSection; symbol: string }) {
  switch (section) {
    case 'fundamentals':
      return <FundamentalsSection symbol={symbol} expanded />;
    case 'financials':
      return <FinancialsSection symbol={symbol} expanded />;
    case 'volume':
      return <VolumeSection symbol={symbol} expanded />;
    case 'options':
      return <OptionsSection symbol={symbol} expanded />;
    case 'orderbook':
      return <OrderBookSection symbol={symbol} expanded />;
    case 'insider':
      ...
      <ScrollArea className="flex-1">
        <div className="p-2">
          {selectedSymbol ? (
            ...
            <div className="text-xs text-[#999999] text-center py-8">
