...
export function VolumeSection({ symbol }: { symbol: string }) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div
        ...
        onClick={() => setExpandedChart({ section: 'volume', chartId: 'volume' })}
      >
