  ...
  if (!expanded) {
    return (
      <div className="flex items-center gap-1.5 whitespace-nowrap">
        <span className="text-[10px] font-semibold text-slate-400">Regime</span>
        <span className="text-[10px] font-bold" style={{ color: regimeColor }}>
          {regime}
        </span>
        <span className="text-[9px] font-mono text-slate-500">{trendStrength}%</span>
  ...
  return (
    <div className="p-3 w-80">
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs font-semibold text-slate-300">Market Regime</span>
        <span
      ...
      <div className="flex items-center gap-3 mb-3 text-[10px]">
        ...
        <span className="text-slate-500">
          Day <span className="font-mono text-slate-300">{daysInRegime}</span>
        </span>
        <span className="text-slate-600">|</span>
          ...
          return (
            <div key={key} className="group">
              <div className="flex items-center justify-between mb-0.5">
                ...
                <div className="flex items-center gap-1.5">
                  <span className="text-[8px] px-1 py-0.5 rounded" style={{ color, backgroundColor: `${color}15` }}>
                    {signal}
                  </span>
