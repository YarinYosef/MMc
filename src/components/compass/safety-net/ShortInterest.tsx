  ...
  if (!expanded) {
    return (
      <div className="flex items-center gap-1.5 whitespace-nowrap">
        <span className="text-[10px] font-semibold text-slate-400">SI</span>
        <span className="text-[10px] font-bold" style={{ color }}>{level}</span>
        <span className="text-[9px] font-mono text-slate-500">{siRatio.toFixed(1)}%</span>
      </div>
    );
  }
  ...
  return (
    <div className="p-3 w-64">
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs font-semibold text-slate-300">Short Interest</span>
      ...
      <div className="space-y-2 mb-3">
        ...
        <div>
          <div className="flex justify-between text-[10px] mb-0.5">
            ...
            <span className="font-mono text-slate-300">{util}%</span>
          </div>
      ...
      <div className="pt-2 border-t border-slate-700/50">
        <div className="flex items-center justify-between mb-1">
          <span className="text-[10px] text-blue-400 font-semibold">{onionLabel} SI</span>
