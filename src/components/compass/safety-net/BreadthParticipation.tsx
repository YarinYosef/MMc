  ...
  if (!expanded) {
    return (
      <div className="flex items-center gap-1.5 whitespace-nowrap">
        <span className="text-[10px] font-semibold text-slate-400">Breadth</span>
  ...
  return (
    <div className="p-3 w-72">
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs font-semibold text-slate-300">Breadth & Participation</span>
            ...
            <div key={label}>
              <div className="flex items-center justify-between mb-0.5">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[8px] text-slate-600">({period})</span>
                </div>
      ...
      <div className="border-t border-slate-700/50 pt-2">
        <div className="grid grid-cols-2 gap-x-3 gap-y-1.5">
          <div className="flex items-center justify-between">
            <span className="text-[9px] text-slate-500">New Highs</span>
            <span className="text-[10px] font-mono text-green-400">{newHighs}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-[9px] text-slate-500">New Lows</span>
            <span className="text-[10px] font-mono text-red-400">{newLows}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-[9px] text-slate-500">A/D Ratio</span>
            <span className="text-[10px] font-mono" style={{ color: adRatio > 1 ? '#22C55E' : '#EF4444' }}>
              {adRatio.toFixed(2)}
            </span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-[9px] text-slate-500">Weighting</span>
