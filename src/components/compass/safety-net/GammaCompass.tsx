  ...
  if (!expanded) {
    return (
      <div className="flex items-center gap-1.5 whitespace-nowrap">
        <span className="text-[10px] font-semibold text-slate-400">GEX</span>
  ...
  return (
    <div className="p-3 w-72">
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs font-semibold text-slate-300">Gamma Exposure</span>
      ...
      <div className="bg-slate-800/30 rounded px-3 py-2 mb-3 flex items-center justify-between">
        <span className="text-[9px] text-slate-500">Net Gamma</span>
          ...
          return (
            <div key={label}>
              <div className="flex items-center justify-between mb-0.5">
                <span className={`text-[10px] ${isOnion ? 'text-blue-400 font-semibold' : 'text-slate-400'}`}>
                  {label}
                </span>
      ...
      <div className="mt-3 pt-2 border-t border-slate-700/50 flex items-center justify-between text-[10px]">
        <div className="flex items-center gap-1.5">
          <span className="text-slate-500">Flip Level</span>
          <span className="font-mono text-slate-300">{Number(d.flipLevel).toLocaleString()}</span>
        </div>
        <div className="flex items-center gap-1.5">
