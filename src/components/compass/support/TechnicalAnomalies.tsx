  ...
  if (!expanded) {
    return (
      <div className="flex items-center gap-1 whitespace-nowrap">
        <span className="text-[10px] font-semibold text-slate-400">Anomaly</span>
        {isNormal ? (
          ...
          <>
            ...
            <span className="text-[9px] font-mono text-red-400">{anomalyCount}</span>
          </>
        )}
      </div>
    );
  ...
  return (
    <div className="p-3 w-60">
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs font-semibold text-slate-300">Technical Anomalies</span>
      ...
      {isNormal ? (
        <div className="bg-slate-800/30 rounded p-3 text-center">
          ...
          <div className="text-[10px] text-green-400 font-semibold">All Clear</div>
          <div className="text-[9px] text-slate-500 mt-0.5">No anomalies detected</div>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-[10px] text-slate-300">{anomaly}</div>
                </div>
                <span
