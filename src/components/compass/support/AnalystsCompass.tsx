  ...
  if (!expanded) {
    return (
      <div className="flex items-center gap-1 whitespace-nowrap">
        <span className="text-[10px] font-semibold text-slate-400">Analysts</span>
        {/* Direction arrow SVG */}
        ...
        <span className="text-[10px] font-bold" style={{ color: dirColor }}>{direction}</span>
        <span className="text-[9px]" style={{ color: spdColor }}>{speed}</span>
      </div>
    );
  }
  ...
  return (
    <div className="p-3 w-56">
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs font-semibold text-slate-300">Analyst Revisions</span>
      ...
      <div className="bg-slate-800/30 rounded px-3 py-2 mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-[10px] text-slate-500">Revision Direction</div>
      ...
      <div className="space-y-2">
        <div>
          <div className="flex justify-between text-[10px] mb-0.5">
            ...
            <span className="font-mono text-slate-300">{coverage} analysts</span>
          </div>
