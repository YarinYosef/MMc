    ...
    >
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            className={cn(
              'flex items-center gap-1.5 px-3 py-2.5 cursor-pointer select-none min-w-0 shrink-0',
          ...
          >
            ...
            <div className="relative shrink-0">
              <div
                ...
                style={{ backgroundColor: signalColor, boxShadow: `0 0 8px ${signalColor}50` }}
              />
        ...
        {!isExpanded && state && (
          <TooltipContent side="bottom" className="max-w-xs">
            <div className="space-y-1">
              ...
              <div className="text-[#999999] text-xs">{config.description}</div>
              <div className="flex items-center gap-3 text-xs">
                <span>
                  Value: <span className="font-mono" style={{ color: signalColor }}>{state.value > 0 ? '+' : ''}{state.value.toFixed(1)}</span>
                </span>
                <span>
                  Conf: <span className="font-mono text-[#999999]">{state.confidence}%</span>
                </span>
                <span className="text-[#777777]">{formatRelativeTime(state.lastUpdated)}</span>
              </div>
            </div>
          </TooltipContent>
        )}
        ...
        <AnimatePresence>
          {isExpanded && state && CompassContent && panelPos && (
            <motion.div
              ...
              className="fixed z-50 bg-[#131313]/98 border border-black rounded-b-lg shadow-2xl shadow-black/50 backdrop-blur-sm"
            ...
            >
              ...
              <div className="px-3 py-1.5 border-t border-black text-[9px] text-[#777777] flex justify-between">
