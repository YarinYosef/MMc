    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex gap-1.5 mb-3">
        ...
        <button
          ...
          className="px-2.5 py-1.5 text-[10px] rounded bg-[#AB9FF2] text-white hover:brightness-110 disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Add
        </button>
      </div>
        ...
        {todos.map((todo, idx) => (
          <div
            ...
            className={`flex items-center gap-2 px-2 py-1.5 rounded group ${
              todo.completed ? 'bg-white/[0.03]' : 'bg-white/[0.03] hover:bg-white/[0.06]'
            }`}
          >
            <button
            ...
            <span
              className={`flex-1 text-xs ${
                todo.completed ? 'text-[#777777] line-through' : 'text-white'
              }`}
            >
              {todo.text}
            </span>
            <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
              <button
                ...
                disabled={idx === 0}
                className="text-[10px] text-[#777777] hover:text-[#999999] disabled:opacity-30 px-0.5"
              >
                ^
              </button>
              <button
