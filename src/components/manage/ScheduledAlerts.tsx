      ...
      <div className="space-y-2 mb-3">
        <div className="flex gap-1.5">
          <input
            ...
            className="w-20 bg-slate-800 border border-slate-600 rounded px-2 py-1.5 text-xs text-slate-200 focus:outline-none focus:border-blue-500 uppercase"
          />
          <select
            value={condition}
          ...
          <input
            ...
            placeholder="Value"
            className="w-20 bg-slate-800 border border-slate-600 rounded px-2 py-1.5 text-xs text-slate-200 focus:outline-none focus:border-blue-500"
          />
          <button
            onClick={addAlert}
            disabled={!value.trim()}
            className="px-2.5 py-1.5 text-[10px] rounded bg-blue-600 text-white hover:bg-blue-500 disabled:opacity-40"
          >
            Set
          </button>
        </div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5">
                <span className="text-xs font-semibold text-slate-200">{alert.ticker}</span>
                <span className="text-[9px] text-slate-400">
                  {CONDITION_LABELS[alert.condition]}
                </span>
                <span className="text-[9px] text-blue-400 font-medium">{alert.value}</span>
              </div>
              {alert.triggeredAt && (
