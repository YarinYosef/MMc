...
function TreemapContent(props: any) {
  ...
  return (
    <g>
      ...
      {width > 40 && height > 25 && (
        <>
          <text x={x + width / 2} y={y + height / 2 - 6} textAnchor="middle" fill="#E2E8F0" fontSize={9} fontWeight={600}>
            {name}
          </text>
          <text
            x={x + width / 2}
...
export function SubSectorRotation() {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="text-[10px] text-slate-400 px-2 pb-1">Sub-sector heatmap by volume</div>
